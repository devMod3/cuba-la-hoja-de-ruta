...
test(
  'Admin About follows the profile-workspace flow and contains every visible control inside the shell',
  async ({ page }) => {
...
test(
  'Admin About Guardar publishes through versioned shared authoring without persisting credentials',
  async ({ page }) => {
